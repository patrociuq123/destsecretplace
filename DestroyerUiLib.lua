...
local OrionLib = {
	...
	Themes = {
		Default = {
			Main = Color3.fromRGB(0,0,205),
			Second = Color3.fromRGB(0,0,139),
...
function OrionLib:MakeNotification(NotificationConfig)
	spawn(function()
		...
		local NotificationFrame = SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(0,0,139), 0, 10), {
...
function OrionLib:MakeWindow(WindowConfig)
	...
	local WindowStuff = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 10), {
		...
		SetChildren(SetProps(MakeElement("TFrame"), {
			...
			AddThemeObject(SetProps(MakeElement("Label", HubName, WindowConfig.HidePremium and 14 or 13), {
	...
	function TabFunction:MakeTab(TabConfig)
		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddDropdown(DropdownConfig)
				...
				local DropdownContainer = AddThemeObject(SetProps(SetChildren(MakeElement("ScrollFrame", Color3.fromRGB(0,0,139), 4), {
					DropdownList
				}), {
					Parent = ItemParent,
				...
				local function AddOptions(Options)
					for _, Option in pairs(Options) do
						local OptionBtn = AddThemeObject(SetProps(SetChildren(MakeElement("Button", Color3.fromRGB(0,0,139)), {
